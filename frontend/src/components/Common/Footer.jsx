...
const Footer = () => {
    return (
        <footer className='border-t py-12'>
            <div className='contaimer mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
                ...
                <div>
                    ...
                    {/* Newsletter form */}
                    <form className="flex">
                        <input type="email" placeholder='Enter your email' className='p-3 w-full text-sm border-t border-l border-b border-gray-400 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all'required />
                        <button type='sumbit' className='bg-black text-white px-6 py-3 text-sm rounded-r-md hover:bg-gray-800 transition-all'>Subscribe</button>
                    </form>
                </div>
                {/* Shop Links */}
            <div>
