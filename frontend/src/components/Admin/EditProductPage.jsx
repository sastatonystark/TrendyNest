        ...
        <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='mb-6'>
                    ...
                    <label className="cursor-pointer border border-gray-300 rounded-md p-2 bg-gray-100 hover:bg-gray-200 inline-block">
                        <input type="file" onChange={handleImageUpload} className='hidden' />{uploading && <p>Uploading Image</p>}Choose File
                    </label>
